...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links.E:\LARAVEL\cobapbl\public\storage' => 'string',
...
'filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links.E:\\LARAVEL\\cobapbl\\public\\storage','logging.default',
...
'excel.temporary_files.force_resync_remote','activitylog.enabled','activitylog.delete_records_older_than_days','activitylog.default_log_name','activitylog.default_auth_driver',
'activitylog.subject_returns_soft_deleted_models','activitylog.activity_model','activitylog.table_name','activitylog.database_connection','ide-helper.filename',
...
'web','api',);
        registerArgumentsSet('routes', 'login','logout','home','berita.index','berita.lainnya','berita.show','berita.komentar.store',
'berita.komentar.update','berita.komentar.destroy','divisi.index','divisi.show','anggota.index',
'anggota.show','prestasi.index','prestasi.create','prestasi.store','prestasi.show',
'prestasi.edit','prestasi.update','prestasi.destroy','prestasi.validate','prestasi.reject',
'pendaftaran.closed','pendaftaran.quota-full','pendaftaran.status','pendaftaran.success','pendaftaran.check-status',
'pendaftaran.check-status.post','pendaftaran.index','pendaftaran.create','pendaftaran.store','pendaftaran.show',
'api.pendaftaran.show','api.pendaftaran-status','admin.dashboard','admin.anggota.index','admin.anggota.create',
'admin.anggota.store','admin.anggota.show','admin.anggota.edit','admin.anggota.update','admin.anggota.destroy',
'admin.divisi.index','admin.divisi.create','admin.divisi.store','admin.divisi.show','admin.divisi.edit',
'admin.divisi.update','admin.divisi.destroy','admin.jabatan.index','admin.jabatan.create','admin.jabatan.store',
'admin.jabatan.show','admin.jabatan.edit','admin.jabatan.update','admin.jabatan.destroy','admin.jabatan.toggle-status',
'admin.prestasi.index','admin.prestasi.create','admin.prestasi.store','admin.prestasi.show','admin.prestasi.edit',
'admin.prestasi.update','admin.prestasi.destroy','admin.prestasi.validasi','admin.prestasi.bulk-action','admin.mahasiswa.index',
'admin.mahasiswa.create','admin.mahasiswa.store','admin.mahasiswa.show','admin.mahasiswa.edit','admin.mahasiswa.update',
'admin.mahasiswa.destroy','admin.mahasiswa.import','admin.mahasiswa.export','admin.mahasiswa.template','admin.mahasiswa-bermasalah.index',
'admin.mahasiswa-bermasalah.create','admin.mahasiswa-bermasalah.store','admin.mahasiswa-bermasalah.show','admin.mahasiswa-bermasalah.edit','admin.mahasiswa-bermasalah.update',
'admin.mahasiswa-bermasalah.destroy','admin.mahasiswa-bermasalah.get-mahasiswa','admin.pendaftaran.index','admin.pendaftaran.create','admin.pendaftaran.store',
'admin.pendaftaran.show','admin.pendaftaran.edit','admin.pendaftaran.update','admin.pendaftaran.destroy','admin.pendaftaran.buka-sesi',
'admin.pendaftaran.tutup-sesi','admin.pendaftaran.update-settings','admin.pendaftaran.update-status','admin.berita.index','admin.berita.create',
'admin.berita.store','admin.berita.show','admin.berita.edit','admin.berita.update','admin.berita.destroy',
'admin.berita.show','admin.pelanggaran.index','admin.pelanggaran.create','admin.pelanggaran.store','admin.pelanggaran.show',
'admin.pelanggaran.edit','admin.pelanggaran.update','admin.pelanggaran.destroy','admin.sanksi.index','admin.sanksi.create',
'admin.sanksi.store','admin.sanksi.show','admin.sanksi.edit','admin.sanksi.update','admin.sanksi.destroy',
'admin.data.users','admin.data.auggets','admin.data.applets','admin.data.process-files','admin.data.scripts',
'admin.data.chat','dashboard','storage.local',);
        registerArgumentsSet('views', 
'admin.anggota','admin.berita','admin.berita.create','admin.berita.edit','admin.berita.index',
'admin.berita.show','admin.dashboard','admin.divisi','admin.divisi.create','admin.divisi.edit',
'admin.divisi.index','admin.divisi.show','admin.jabatan.create','admin.jabatan.edit','admin.jabatan.index',
'admin.mahasiswa-bermasalah.create','admin.mahasiswa-bermasalah.edit','admin.mahasiswa-bermasalah.index','admin.mahasiswa.create','admin.mahasiswa.edit',
'admin.mahasiswa.form','admin.mahasiswa.index','admin.mahasiswa.show','admin.pelanggaran-sanksi','admin.pelanggaran.create',
'admin.pelanggaran.edit','admin.pelanggaran.index','admin.pendaftaran','admin.pendaftaran.index','admin.pendaftaran.partials.edit_form',
'admin.prestasi.create','admin.prestasi.edit','admin.prestasi.form','admin.prestasi.index','admin.prestasi.show',
'admin.sanksi.create','admin.sanksi.edit','admin.sanksi.index','anggota','auth.login',
'berita','berita.index','berita.lainnya','berita.show','coba',
'divisi','index','lanjutan','layouts.admin.app','layouts.app',
'layouts.app_admin','layouts.sidebar-admin','layouts.user.app','layouts.user.sidebar','pendaftaran.create',
'pendaftaran.edit','users.dashboard','users.pendaftaran.check-status','users.pendaftaran.closed','users.pendaftaran.create',
'users.pendaftaran.edit','users.pendaftaran.index','users.pendaftaran.quota-full','users.pendaftaran.show','users.pendaftaran.status',
'users.pendaftaran.success','users.prestasi.create','users.prestasi.edit','users.prestasi.form','users.prestasi.index',
'users.prestasi.show','welcome','laravel-exceptions-renderer::components.card','laravel-exceptions-renderer::components.context','laravel-exceptions-renderer::components.copy-button',
...
'E:.LARAVEL.cobapbl.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.failed','E:.LARAVEL.cobapbl.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.password','E:.LARAVEL.cobapbl.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.throttle','E:.LARAVEL.cobapbl.vendor.laravel.framework.src.Illuminate.Translation.lang.en.pagination.previous','E:.LARAVEL.cobapbl.vendor.laravel.framework.src.Illuminate.Translation.lang.en.pagination.next',
'E:.LARAVEL.cobapbl.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.reset','E:.LARAVEL.cobapbl.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.sent','E:.LARAVEL.cobapbl.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.throttled','E:.LARAVEL.cobapbl.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.token','E:.LARAVEL.cobapbl.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.user',
'E:.LARAVEL.cobapbl.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.accepted','E:.LARAVEL.cobapbl.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.accepted_if','E:.LARAVEL.cobapbl.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.active_url','E:.LARAVEL.cobapbl.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.after','E:.LARAVEL.cobapbl.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.after_or_equal',
'E:.LARAVEL.cobapbl.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha','E:.LARAVEL.cobapbl.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha_dash','E:.LARAVEL.cobapbl.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha_num','E:.LARAVEL.cobapbl.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.any_of','E:.LARAVEL.cobapbl.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.array',
'E:.LARAVEL.cobapbl.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ascii','E:.LARAVEL.cobapbl.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.before','E:.LARAVEL.cobapbl.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.before_or_equal','E:.LARAVEL.cobapbl.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.array','E:.LARAVEL.cobapbl.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.file',
'E:.LARAVEL.cobapbl.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.numeric','E:.LARAVEL.cobapbl.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.string','E:.LARAVEL.cobapbl.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.boolean','E:.LARAVEL.cobapbl.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.can','E:.LARAVEL.cobapbl.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.confirmed',
'E:.LARAVEL.cobapbl.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.contains','E:.LARAVEL.cobapbl.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.current_password','E:.LARAVEL.cobapbl.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date','E:.LARAVEL.cobapbl.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date_equals','E:.LARAVEL.cobapbl.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date_format',
'E:.LARAVEL.cobapbl.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.decimal','E:.LARAVEL.cobapbl.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.declined','E:.LARAVEL.cobapbl.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.declined_if','E:.LARAVEL.cobapbl.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.different','E:.LARAVEL.cobapbl.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.digits',
'E:.LARAVEL.cobapbl.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.digits_between','E:.LARAVEL.cobapbl.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.dimensions','E:.LARAVEL.cobapbl.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.distinct','E:.LARAVEL.cobapbl.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_contain','E:.LARAVEL.cobapbl.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_end_with',
'E:.LARAVEL.cobapbl.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_start_with','E:.LARAVEL.cobapbl.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.email','E:.LARAVEL.cobapbl.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ends_with','E:.LARAVEL.cobapbl.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.enum','E:.LARAVEL.cobapbl.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.exists',
'E:.LARAVEL.cobapbl.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.extensions','E:.LARAVEL.cobapbl.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.file','E:.LARAVEL.cobapbl.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.filled','E:.LARAVEL.cobapbl.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.array','E:.LARAVEL.cobapbl.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.file',
'E:.LARAVEL.cobapbl.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.numeric','E:.LARAVEL.cobapbl.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.string','E:.LARAVEL.cobapbl.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.array','E:.LARAVEL.cobapbl.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.file','E:.LARAVEL.cobapbl.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.numeric',
'E:.LARAVEL.cobapbl.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.string','E:.LARAVEL.cobapbl.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.hex_color','E:.LARAVEL.cobapbl.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.image','E:.LARAVEL.cobapbl.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in','E:.LARAVEL.cobapbl.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in_array',
'E:.LARAVEL.cobapbl.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in_array_keys','E:.LARAVEL.cobapbl.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.integer','E:.LARAVEL.cobapbl.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ip','E:.LARAVEL.cobapbl.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ipv4','E:.LARAVEL.cobapbl.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ipv6',
'E:.LARAVEL.cobapbl.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.json','E:.LARAVEL.cobapbl.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.list','E:.LARAVEL.cobapbl.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lowercase','E:.LARAVEL.cobapbl.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.array','E:.LARAVEL.cobapbl.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.file',
'E:.LARAVEL.cobapbl.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.numeric','E:.LARAVEL.cobapbl.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.string','E:.LARAVEL.cobapbl.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.array','E:.LARAVEL.cobapbl.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.file','E:.LARAVEL.cobapbl.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.numeric',
'E:.LARAVEL.cobapbl.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.string','E:.LARAVEL.cobapbl.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mac_address','E:.LARAVEL.cobapbl.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.array','E:.LARAVEL.cobapbl.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.file','E:.LARAVEL.cobapbl.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.numeric',
'E:.LARAVEL.cobapbl.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.string','E:.LARAVEL.cobapbl.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max_digits','E:.LARAVEL.cobapbl.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mimes','E:.LARAVEL.cobapbl.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mimetypes','E:.LARAVEL.cobapbl.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.array',
'E:.LARAVEL.cobapbl.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.file','E:.LARAVEL.cobapbl.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.numeric','E:.LARAVEL.cobapbl.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.string','E:.LARAVEL.cobapbl.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min_digits','E:.LARAVEL.cobapbl.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing',
'E:.LARAVEL.cobapbl.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_if','E:.LARAVEL.cobapbl.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_unless','E:.LARAVEL.cobapbl.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_with','E:.LARAVEL.cobapbl.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_with_all','E:.LARAVEL.cobapbl.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.multiple_of',
'E:.LARAVEL.cobapbl.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.not_in','E:.LARAVEL.cobapbl.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.not_regex','E:.LARAVEL.cobapbl.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.numeric','E:.LARAVEL.cobapbl.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.letters','E:.LARAVEL.cobapbl.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.mixed',
'E:.LARAVEL.cobapbl.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.numbers','E:.LARAVEL.cobapbl.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.symbols','E:.LARAVEL.cobapbl.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.uncompromised','E:.LARAVEL.cobapbl.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present','E:.LARAVEL.cobapbl.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_if',
'E:.LARAVEL.cobapbl.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_unless','E:.LARAVEL.cobapbl.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_with','E:.LARAVEL.cobapbl.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_with_all','E:.LARAVEL.cobapbl.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited','E:.LARAVEL.cobapbl.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if',
'E:.LARAVEL.cobapbl.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if_accepted','E:.LARAVEL.cobapbl.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if_declined','E:.LARAVEL.cobapbl.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_unless','E:.LARAVEL.cobapbl.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibits','E:.LARAVEL.cobapbl.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.regex',
'E:.LARAVEL.cobapbl.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required','E:.LARAVEL.cobapbl.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_array_keys','E:.LARAVEL.cobapbl.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if','E:.LARAVEL.cobapbl.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if_accepted','E:.LARAVEL.cobapbl.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if_declined',
'E:.LARAVEL.cobapbl.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_unless','E:.LARAVEL.cobapbl.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_with','E:.LARAVEL.cobapbl.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_with_all','E:.LARAVEL.cobapbl.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_without','E:.LARAVEL.cobapbl.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_without_all',
'E:.LARAVEL.cobapbl.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.same','E:.LARAVEL.cobapbl.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.array','E:.LARAVEL.cobapbl.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.file','E:.LARAVEL.cobapbl.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.numeric','E:.LARAVEL.cobapbl.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.string',
'E:.LARAVEL.cobapbl.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.starts_with','E:.LARAVEL.cobapbl.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.string','E:.LARAVEL.cobapbl.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.timezone','E:.LARAVEL.cobapbl.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.unique','E:.LARAVEL.cobapbl.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uploaded',
'E:.LARAVEL.cobapbl.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uppercase','E:.LARAVEL.cobapbl.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.url','E:.LARAVEL.cobapbl.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ulid','E:.LARAVEL.cobapbl.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uuid','E:.LARAVEL.cobapbl.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.custom.attribute-name.rule-name',);
