    ...
    <div class="row">
        <div class="col-md-8">
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('admin.jabatan.update', $jabatan->id_jabatan) }}" id="jabatanForm">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="mb-4">
                            ...
                            <select class="form-select form-control @error('level') is-invalid @enderror" 
                                ...
                                @for($i = 1; $i <= 10; $i++)
                                    <option value="{{ $i }}" {{ old('level', $jabatan->level) == $i ? 'selected' : '' }}>
                                        Level {{ $i }}
                                    </option>
                                @endfor
                            </select>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="form-check form-switch">
                                <input class="form-check-input" type="checkbox" 
                                       ...
                                       {{ old('status', $jabatan->status) ? 'checked' : '' }}>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Jika ada nilai level, update nama jabatan
