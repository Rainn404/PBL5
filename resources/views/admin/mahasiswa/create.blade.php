...
@section('title', 'Tambah Data Mahasiswa - HIMA-TI')
        ...
        <div class="col-12">
            <div class="card shadow mb-4">
                <div class="card-body">
                    <!-- Form Header -->
                    <div class="mb-5">
                        <h2 class="h4 text-gray-900 mb-2">Tambah Data Mahasiswa Baru</h2>
                        <p class="text-muted mb-0">Isi form berikut untuk menambahkan data mahasiswa baru</p>
                    </div>
